...
const AYAR_ADI: Record<ayar.Anahtar, { ad: string; birim: "tl" | "saat" | "gun" | "metre" }> = {
  ...
  [ayar.ANAHTARLAR.butceGun1]: { ad: "Pazartesi bütçesi", birim: "tl" },
  [ayar.ANAHTARLAR.butceGun2]: { ad: "Salı bütçesi", birim: "tl" },
  [ayar.ANAHTARLAR.butceGun3]: { ad: "Çarşamba bütçesi", birim: "tl" },
  [ayar.ANAHTARLAR.butceGun4]: { ad: "Perşembe bütçesi", birim: "tl" },
  [ayar.ANAHTARLAR.butceGun5]: { ad: "Cuma bütçesi", birim: "tl" },
  [ayar.ANAHTARLAR.butceGun6]: { ad: "Cumartesi bütçesi", birim: "tl" },
  [ayar.ANAHTARLAR.butceGun7]: { ad: "Pazar bütçesi", birim: "tl" },
