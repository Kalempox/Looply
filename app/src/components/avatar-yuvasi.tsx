      ...
      */}
      {!disarida && (
        <button
          ...
          className="avatar-yuva fixed right-3 bottom-[4.75rem] z-20 grid size-12 place-items-center rounded-full border border-cizgi bg-yuzey shadow-[0_10px_26px_-10px_rgba(16,32,77,0.55)] active:scale-95"
        >
      ...
      {disarida && (
        ...
        >
          <button
            ...
            className="absolute inset-0 bg-yazi/55"
          />
