...
| E6 | **Kanıt seviyesi ödül değerine bağlı** | 1–15 TL → K2 · 16–50 TL → K3 · 51 TL+ → K4 · her kullanım → K5. |
| E7 | **Kasiyer ekranı birinci sınıf** | Sonradan eklenen panel değil. Kasiyer kullanmazsa hiçbir rapor doğru olmaz. |
| E8 | **Şans Çarkı v1'de yok** | Rastgele ödül bütçe öngörülebilirliğini bozar; ayrıca promosyon mevzuatı riski (S7). |
